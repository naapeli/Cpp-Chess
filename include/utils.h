...
namespace constants
{
    ...
    const string square_to_coordinates[64] = {
        "a8", "b8", "c8", "d8", "e8", "f8", "g8", "h8",
        "a7", "b7", "c7", "d7", "e7", "f7", "g7", "h7",
        "a6", "b6", "c6", "d6", "e6", "f6", "g6", "h6",
        "a5", "b5", "c5", "d5", "e5", "f5", "g5", "h5",
    ...
    const string promotion_to_string = " NB R   Q";
    ...
    const unordered_map<char, int> string_to_piece = {{'P', P}, {'N', N}, {'B', B}, {'R', R}, {'Q', Q}, {'K', K}, {'p', p}, {'n', n}, {'b', b}, {'r', r}, {'q', q}, {'k', k}};
    const string piece_to_string = "PNBRQKpnbrqk.";
    const unordered_map<char, int> string_to_promotion = {{'q', promotion_queen}, {'r', promotion_rook}, {'b', promotion_bishop}, {'n', promotion_knight}, {'Q', promotion_queen}, {'R', promotion_rook}, {'B', promotion_bishop}, {'N', promotion_knight}};
